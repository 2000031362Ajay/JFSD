...
<span class="blink">
<h3 align=center style="color: red"><c:out value="${msg}"/></h3><br>
</span>
...
<input type="password" name="eopwd" required><br><br><br><br>
<label>New Password</label></td><br><br>
<input type="password" name="enpwd" required><br><br><br><br>
