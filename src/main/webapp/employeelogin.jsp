...
<br><br>
<div class="box">
<h3 align=center class="h3" style="color: white">Traveller Login</h3>
...
<input type="text" name="euname" required><br><br><br>
<label style="color: white">Password:</label><br><br>
<input type="password" name="epwd" required minlength="8" maxlength="16"><br><br>
...
New Traveller ??? <a href="employeereg">Register Here</a>
