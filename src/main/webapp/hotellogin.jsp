...
<body>
<img class="img" src="images/hotel.png" alt="img1" style="width:100%">
<ul>
  <li><a href="/">Home</a></li>
...
<br><br>
<div class="box">
<h3 align=center class="h3">Hotel Login</h3>
...
<input type="text" name="hoteluname" required><br><br><br>

<label style="color: white">Password:</label><br><br>
<input type="password" name="hotelpwd" required><br><br>
...
New Hotel??? <a href="hotelregistration">Register Here</a>
</div>
</h3>
