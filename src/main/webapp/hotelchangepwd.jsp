...
<div class="box">
<h3 align=center class="h3">Welcome&nbsp;<c:out value="${hoteluname}"></c:out></h3>

<h3 align=center>Change Password</h3><br><br>
...
<input type="password" name="htlopwd" required><br><br><br>

<label>New Password</label><br><br>
<input type="password" name="htlnpwd" required><br><br>
