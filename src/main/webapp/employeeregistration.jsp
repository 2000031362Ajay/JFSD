...
<div class="box">
<h3 align=center class="h3">Traveller Registration</h3>
...
<form:input path="dateofbirth" required="required" placeholder="DD/MM/YYYY"/><br><br>
...
<form:password path="password" required="required" min="8" max="16"/><br><br>
