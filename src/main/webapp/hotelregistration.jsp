...
<ul>
  ...
  <li><a class="active" href="employeelogin">Traveller</a></li>
  
</ul>

<br><br>
<div class="box">
<h3 align=center class="h3">Hotel Registration</h3>
...
<form:form action="addhotel" method="post" modelAttribute="htl">

<table align=center>

<label>Name</label><br><br>
<form:input path="hname" required="required"></form:input><br><br>


<label>Location</label><br><br>
<form:input path="location" required="required"/><br><br>

<label>Address</label><br><br>
<form:input path="address" required="required"/><br><br>

<label>Email ID</label><br><br>
<form:input path="emailid" required="required"/><br><br>

<label>Username</label><br><br>
<form:input path="username" required="required"/><br><br>

<label>Password</label><br><br>
<form:password path="password" required="required" minlength="8" maxlength="16"/><br><br>
